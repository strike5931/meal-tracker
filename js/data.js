...
MT.defaults = {
  ...
  meals: {
    ...
    train_pm: [
      { id: 'tp1', name: '第一餐', items: '米糊 100g・香蕉 50g・水解乳清 30g・杏仁醬 25g', note: '', tag: false },
      { id: 'tp2', name: '第二餐', items: '生米 100g・雞胸/瘦牛 75g・橄欖油 5g', note: '', tag: false },
      { id: 'tp3', name: '第三餐', items: '生米 75g・雞胸/瘦牛 75g・橄欖油 5g', note: '', tag: false },
      { id: 'tp4', name: '⭐ 練前餐', items: '米糊 50g・香蕉 50g', note: '吃完後開始訓練', tag: true },
      { id: 'tp5', name: '⭐ 練後餐', items: '玉米片 50g・水解乳清 30g', note: '吃完 45 分鐘後才吃正餐', tag: true },
      { id: 'tp6', name: '最後一餐', items: '生米 50g・生鮭魚 75g', note: '睡前 1-1.5 小時吃完', tag: false }
    ],
    rest: [
  ...
  macros: {
    ...
    train_pm: { kcal: '~2,500', carbs: '363g', protein: '~155g', fat: '~45g' },
